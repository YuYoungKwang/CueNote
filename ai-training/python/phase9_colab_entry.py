...
from cuenote_ai.colab_pipeline import prepare_dataset, prepare_environment, train_symbol_overfit, train_task


def main() -> None:
    parser = argparse.ArgumentParser(description="CueNote Phase 9E-H Colab pipeline")
    parser.add_argument("--run-mode", default=os.environ.get("CUENOTE_RUN_MODE", "SMOKE"), choices=["SMOKE", "LAYOUT_TRAIN", "SYMBOL_TRAIN", "SYMBOL_OVERFIT", "FULL_PIPELINE"])
